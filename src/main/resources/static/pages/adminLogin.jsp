...
<body background="http://www.lsdfj.com/wx/images/bgp/4.jpg"  style="background-size:100% 100%;background-repeat:no-repeat;">
...
<script type="text/javascript">
		function adminlogin(){					
			...
			var server="http://www.lsdfj.com/wx/admin/login";
			var datas={};			
			datas["username"] = $("#username").val();
			datas["userpwd"] =  $("#password").val();						
			$.ajax({
	    	    type: "post",
	    	    dataType : "json",
	    	    url: server,
