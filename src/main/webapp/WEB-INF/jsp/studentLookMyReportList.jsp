  ...
  <body>
      ...
      <div class="row">
			    ...
			    <div class="panel panel-default">
			        <div class="panel-heading">
			            <h4 class="panel-title">
			                <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour" style="text-decoration: none;">报告管理</a>
			            </h4>
			        </div>
        ...
        <div class="col-sm-9  col-md-10  main"  style="margin-top:40px;" >
        	...
        	<div  id="div1" style="background-color:#FFFFE0;padding-top:60px;padding-left:50px; height:543px;">
				<div  id="div1" style="background-color:#FFFFE0;padding-top:15px;padding-left:40px; height:563px;">
					<!--第二步：添加如下 HTML 代码-->
	...
	<div class="modal fade" id="myModalReport" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content" style="width:840px; height:580px;margin-right:100px;padding:0px;">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="editModalLabel">查看报告</h4>
				</div>
				<div id="report" style="margin-top: 15px;">
...
<!-- <div id="div11" style="width:100%; height:20px;padding-left:40%;">
						 		 <button type="button" class="btn btn-primary" onclick="writereport()">返回</button>
				   		</div>		 -->
	<script type="text/javascript">
		        ...
		        columns: [
		                  ...
		                  { data: 'grade' },
 		                  { data: null,"render":function(data,type,row,meta){
		                	  var html="<button   id='toLookReport' name='toLookReport' class='btn btn-info btn-xs'  data-toggle='modal' data-target='#myModalReport' style='margin:0px;margin-right:3px;'  >查看</button><button id='toExportReport' name='toExportReport' class='btn btn-success btn-xs' style='margin:0px;'>导出</button>";
		                  	  return html;
 		                  	}
		                  }
		...
		$(document).on("click", "#toExportReport", function(se) {
			var $select = $(this).parent().parent();
			var rData = $('#tableData').DataTable().row($select).data();
			var server = "/student/studentExportReportByRid";
			var datas = {};
			datas["rid"] = rData.rid;
			datas["sname"] = rData.sname;
			datas["grade"] = rData.grade;
			$.ajax({
				...
				success : function(result) {
					if(result.code==0){
	    	    		...
	    	    		window.location.href="/student/studentLookMyReportList";
	    	    	}else{
	    	    		alert(result.message);
	    	    		return false;		
	    	    	}
