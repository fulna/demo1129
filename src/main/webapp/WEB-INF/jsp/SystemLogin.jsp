		     ...
		     <div class="row">
		          <div class="col-md-offset-3 col-md-6">
		              <form class="form-horizontal" id="from1">
		                    <span class="heading">选择用户身份</span>
		                     <div class="form-group">
		                            <a href="/teacher/hello">导师登录 </a>
		                      </div>
		                       <div class="form-group help">
		                            <a href="/student/hello">学生登录 </a>
		                       </div>
		                       <div class="form-group">
		                           <a href="/admin/hello">管理员登录 </a>
		                       </div>
		                   </form>
		               </div>
		           </div>
