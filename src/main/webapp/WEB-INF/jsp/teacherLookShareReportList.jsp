  ...
  <body>
	...
	<div class="modal fade" id="myModalReport" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content" style="width: 800px; height: 600spx;">
	...
	<div id="div1" style="background-color: #FFFFE0; padding-top: 15px; padding-left: 40px; height: 590px;">
		<div id="div3" style="border: 1px solid #000; width: 95%; height: 480px;">
	...
	<script type="text/javascript">
		$(document).ready( function () {
		    var datatable = $('#tableData').DataTable( {
		        ...
		        ajax: {
		            url: '/teacher/tlooksharereportlist',
		            dataSrc: 'data'
		        },
		        columns: [
		                  { data: 'rsid' },
		                  ...
		                  { data: 'rssharetime' },
 		                  { data: null,"render":function(data,type,row,meta){
		                	  var html="<button   id='toLookReport' name='toLookReport' class='btn btn-info btn-xs'  data-toggle='modal' data-target='#myModalReport' style='margin:0px;'  >查看报告</button>";
		                  	  return html;
 		                  	}
		                  }        
		              ]
